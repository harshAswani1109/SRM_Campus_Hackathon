  ...
  return (
    <main>
      ...
      <div className="text-[#30449e] text-4xl">
        <h1 className="h-20 p-4 text-[#04aa6d] bg-black">Canteen Interface</h1>
            ...
            <div className="w-3/5 my-10 mx-10 p-4  border-4 border-black border-solid">
              ...
              <table className="table-auto ">
                <thead className="border-solid border-black border-2">
                  <tr>
                    <th className="border-solid border-black border-2 w-full">
                      Items
                    </th>
                    <th className="border-solid border-black border-2 w-full">
                      Quantity
                ...
                <tbody className="border-solid border-black border-2">
                  <tr>
                    ...
                    <td className="border-solid border-black border-2">200</td>
                  </tr>
                </tbody>
              </table>
            </div>
