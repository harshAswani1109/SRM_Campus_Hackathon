...
import wnu from "../../public/images/wnu.jpg";
              ...
              <div>
                <form className="ml-4">
                  ...
                  <div className="mb-10 h-10">
                    ...
                    <div className="w-96 flex items-center justify-between text-lg ">
                      <label className="disable border-[#e3e3e3] border-2 border-solid h-10 mt-1.5 border-r-0 placeholder:">
                        +91
                      </label>
                      <input
                        type="text"
